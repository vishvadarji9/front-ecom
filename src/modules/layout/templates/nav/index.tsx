...
//               {isProductDropdownOpen && (
//                 <div className="absolute top-full left-0 bg-white border mt-2 p-2 w-48 shadow-lg z-50">
//                   <LocalizedClientLink href="/face-care" className="block px-4 py-2 text-sm hover:bg-gray-200">
//                     Face Care
//                   </LocalizedClientLink>
//                   <LocalizedClientLink href="/hair-care" className="block px-4 py-2 text-sm hover:bg-gray-200">
//                     Hair Care
//                   </LocalizedClientLink>
//                   <LocalizedClientLink href="/body-care" className="block px-4 py-2 text-sm hover:bg-gray-200">
//                     Body Care
//                   </LocalizedClientLink>
//                 </div>
//               )}
...
//                     <div className="dropdown1">
//                       <LocalizedClientLink href="/" onClick={(e: MouseEvent) => e.preventDefault()}>
//                         <li>Product</li> 
//                       </LocalizedClientLink>

//                       <LocalizedClientLink href="/contactus">
//                         <li>Contact us</li>
//                       </LocalizedClientLink>

//                       <div className="dropdown-content1">
//                         <LocalizedClientLink href="/face-care">Face Care</LocalizedClientLink>
//                         <LocalizedClientLink href="/hair-care">Hair Care</LocalizedClientLink>
//                         <LocalizedClientLink href="/body-care">Body Care</LocalizedClientLink>
//                       </div>
//                     </div>
//                   </ul>
//                 </div>
...
//                     <div className="dropdown1">
//                       <LocalizedClientLink href="/" onClick={(e) => e.preventDefault()}>
//                         <li>Product</li> 
//                       </LocalizedClientLink>
...
//           <div className="hidden md:flex flex-1 basis-0 h-full items-center">
//             <div className="h-full">
//               <SideMenu regions={regions} />
//             </div>
//           </div>
...
//               {isProductDropdownOpen && (
//                 <div className="absolute top-full left-0 bg-white border mt-2 p-2 w-48 shadow-lg z-50">
//                   <LocalizedClientLink href="/produts/face-care" className="block px-4 py-2 text-sm hover:bg-gray-200">
//                     Face Care
//                   </LocalizedClientLink>
//                   <LocalizedClientLink 
//                   href="/products/collections/hair-care"
//                   rel="noreferrer"
//                    className="block px-4 py-2 text-sm hover:bg-gray-200">
//                     Hair Care
//                   </LocalizedClientLink>
//                   <LocalizedClientLink href="/products/body-care" className="block px-4 py-2 text-sm hover:bg-gray-200">
//                     Body Care
//                   </LocalizedClientLink>
//                 </div>
//               )}
...
import { Suspense, useState, useEffect, useRef, MouseEvent } from "react";
import LocalizedClientLink from "@modules/common/components/localized-client-link";
import CartButton from "@modules/layout/components/cart-button";
import SideMenu from "@modules/layout/components/side-menu";
import "../nav/sty.css";
        ...
        <nav className="content-container txt-xsmall-plus text-ui-fg-subtle flex items-center justify-between w-full h-full text-small-regular">
          ...
          <div className="hidden md:flex gap-20 justify-center text-center">
            ...
            <div className="relative flex items-center h-full" ref={productDropdownRef}>
              ...
              {isProductDropdownOpen && (
                <div className="absolute top-full left-0 bg-white border mt-2 p-2 w-48 shadow-lg z-50">
                  <LocalizedClientLink href={"/collections/face-care"} className="block px-4 py-2 text-sm hover:bg-gray-200">
                    Face Care
                  </LocalizedClientLink>
                  <LocalizedClientLink href={"/collections/hair-care"} className="block px-4 py-2 text-sm hover:bg-gray-200">
                    Hair Care
                  </LocalizedClientLink>
                  <LocalizedClientLink href={"/collections/body-care"} className="block px-4 py-2 text-sm hover:bg-gray-200">
                    Body Care
                  </LocalizedClientLink>
                </div>
              )}
              ...
              <div ref={sidebarRef} className={`sidebar ${isSidebarOpen ? 'open' : ''}`} id="sidebar" onClick={(e) => e.stopPropagation()}>
                <div className="sidenav">
                  <ul>
                    ...
                    <div className="dropdown1">
                      <LocalizedClientLink href="/" >
                        <li  onClick={preventDefaultHandler()}>Product </li>
                      </LocalizedClientLink>
                      ...
                      <div className="dropdown-content1">
                        <LocalizedClientLink href={"/collections/face-care"}>Face Care</LocalizedClientLink>
                        <LocalizedClientLink href={"/collections/hair-care"}>Hair Care</LocalizedClientLink>
                        <LocalizedClientLink href={"/collections/body-care"}>Body Care</LocalizedClientLink>
                      </div>
                    </div>
                  </ul>
                </div>

    ...
    <footer className="border-t-0 border-ui-border-base w-full">
      <div className="content-container flex flex-col w-full">
        ...
        <div className="flex flex-col gap-y-6 xsmall:flex-row items-start justify-between py-40">
          <div>
            ...
            <div className="logo lg:mr-10 md:mr-10 sm:mr-10 xsmall:mr-10 h-36 w-50 -mt-5">
              {/* <Image className="xsmall:ml-0 -ml-7"
              ...
              <p className="txt text-sm w-52 -ml-0 xsmall:ml-7 text-lime-900">Orgita is an online marketplace specializing in organic products.</p>
            </div>
        ...
        <SubmitButton className="w-full mt-6" data-testid="contact-button">
          ...
          {/* div className="text-small-regular gap-10 md:gap-x-16 grid grid-cols-2 sm:grid-cols-3"> */}
          <div className="text-small-regular gap-10 md:gap-x-16 grid md:grid-cols-3 lg:grid-cols-4 sm:grid-cols-2 xsmall:grid-cols-2 ml-96">
            {product_categories && product_categories?.length > 0 && (
              <div className="flex flex-col gap-y-2">
                <span className="txt-small-plus txt-ui-fg-base">
                  Categories
